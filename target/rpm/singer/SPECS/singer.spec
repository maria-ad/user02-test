...
Name: singer
Version: 0.2.7
Release: SNAPSHOT20180623123049
Summary: singer
License: (c) null
...
Prefix: /usr/local
BuildArch: noarch
BuildRoot: /home/user2/user02-test/target/rpm/singer/buildroot
...
if [ -d $RPM_BUILD_ROOT ];
then
  mv /home/user2/user02-test/target/rpm/singer/tmp-buildroot/* $RPM_BUILD_ROOT
else
  mv /home/user2/user02-test/target/rpm/singer/tmp-buildroot $RPM_BUILD_ROOT
fi
